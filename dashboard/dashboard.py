...
with tab1: 
    with st.container(): 
        ...
        sns.barplot(x=product_category.index, y=product_category)
...
with tab2: 
    with st.container(): 
        ...
        sns.barplot(x=payment_type.index[:4], y=payment_type[:4])
        ...
        sns.barplot(x=payment_installments.index[1:13], y=payment_installments[1:13])
...
with tab3: 
    with st.container(): 
        ...
        sns.barplot(x=city_customers, y=city_customers.index)
        plt.xlabel('Jumlah')
        plt.ylabel('Kota')
...
with tab4: 
    with st.container(): 
        ...
        sns.barplot(x=city_sellers, y=city_sellers.index)
        plt.xlabel('Jumlah')
        plt.ylabel('Kota')
